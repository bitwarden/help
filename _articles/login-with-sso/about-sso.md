...
Users of Bitwarden authenticate into their vaults using the **Enterprise Single Sign-On** button located on the login screen of any Bitwarden client application. For more information, see [Access Your Vault Using SSO]({{site.baseurl}}/article/sso-access-your-vault/).
...
- [Configure Login with SSO (SAML 2.0)]({{site.baseurl}}/article/configure-sso-saml/)
- [Configure Login with SSO (OIDC)]({{site.baseurl}}/article/configure-sso-oidc)

For existing users, see:
- [Link an Existing Account to SSO]({{site.baseurl}}/article/link-to-sso/)
- [Access Your Vault Using SSO]({{site.baseurl}}/article/sso-access-your-vault/)

For more information, see:
- [SSO FAQs]({{site.baseurl}}/article/sso-faqs)
