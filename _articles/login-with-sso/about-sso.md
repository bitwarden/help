...
Users of Bitwarden authenticate into their vaults using the **Enterprise Single Sign-On** button located on the login screen of any Bitwarden client application. For more information, see [Access Your Vault Using SSO]({{site.baseurl}}/sso-access-your-vault/).

Administrators can configure Login with SSO in the Business Portal. For more information, see [About the Business Portal]({{site.baseurl}}/about-business-portal/).
...
For information on updating your self-hosted instance, see [Updating your Self-Hosted Installation]({{site.baseurl}}/updating-on-premise/).
...
- [Configure Login with SSO (SAML 2.0)]({{site.baseurl}}/configure-sso-saml/)
- [Configure Login with SSO (OIDC)]({{site.baseurl}}/configure-sso-oidc)

For existing users, see:
- [Link an Existing Account to SSO]({{site.baseurl}}/link-to-sso/)
- [Access Your Vault Using SSO]({{site.baseurl}}/sso-access-your-vault/)

For more information, see:
- [SSO FAQs]({{site.baseurl}}/sso-faqs)
