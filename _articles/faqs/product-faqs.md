...
The ability to view the password history of a Login Item is available for the last 5 passwords. You can open the item in question and select the "1" next to Password History near the bottom of the window.
