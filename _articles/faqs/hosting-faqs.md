...
- [**Bitwarden Server service/user account and (optional: systemd service configuration**)](#bitwarden-server-service-user-account-and--optional--systemd-service-configuration-)
  * [**Certificate Setup for Private CA, On-premises/self-hosted**](#--certificate-setup-for-private-ca--on-premises-self-hosted--)
  * [**Certificate Setup for Public CA, On-premises/self-hosted**](#--certificate-setup-for-public-ca--on-premises-self-hosted--)
  * [**Change Server Name**](#--change-server-name--)
  * [**Gmail self-hosted config**](#--gmail-self-hosted-config--)
  * [**High Availability**](#--high-availability--)
  * [**Let's Encrypt Manual Update (issue or domain/server name change)**](#--let-s-encrypt-manual-update--issue-or-domain-server-name-change---)
  * [**Migrate cloud to on-premise**](#--migrate-cloud-to-on-premise--)
- [**Restore Bitwarden Server Detailed (Restore Backup)**](#--restore-bitwarden-server-detailed--restore-backup---)
  * [**Custom Server Ports**](#--custom-server-ports--)
  * [**SMTP Config w/ Mail Service Options**](#--smtp-config-w--mail-service-options--)
  ...
  * [**Q: When does a “Remember Me” 2FA selection:**](#--q--when-does-a--remember-me--2fa-selection---)
...
### **Q: When does a “Remember Me” 2FA selection:**
