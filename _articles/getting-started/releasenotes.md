...
- **Provider Portal**: The Provider Portal allows Managed Service Providers (MSPs), Resellers, and other businesses to create and administer Organizations on behalf of customers. Using the Portal, the Providers can seamlessly support credential management across multiple customers (see [here]({{site.baseurl}}/article/getting-started-providers/) for details).
