...
- [More on Items]({{site.baseurl}}/managing-items/)
- [Attaching a file to an item]({{site.baseurl}}/attachments/)
...
For more on creating a Bitwarden Organization, visit [this article.]({{site.baseurl}}/about-organizations/)

Self-hosted instances will need to create an Organization on the Bitwarden cloud instance to generate their [license key](https://bitwarden.com/host/) and can then proceed with [installing and configuring a Bitwarden Server instance.]({{site.baseurl}}/install-on-premise/)
...
Each Bitwarden Organization can configure one SSO provider. Configuration for this is located in the [Business Portal]({{site.baseurl}}/about-business-portal/), accessible from the Web Vault by Organization Owners and Administrators.

For more details on Login with SSO configurations and examples of Identity Provider (IdP) settings and naming conventions, please visit [these help articles]({{site.baseurl}}/about-sso/).

### Enabling enterprise policies

Policies are found in the [Business Portal]({{site.baseurl}}/about-business-portal/)

Policies allow you to control the actions of users within your Organization. It is recommended to configure these policies prior to onboarding users. For a complete list and details for Enterprise Policies, please see our helpful article [here.]({{site.baseurl}}/policies/)
...
For instructions on shaping a Bitwarden specific import file, please refer to the guide [here.]({{site.baseurl}}/condition-bitwarden-import/)

 A collection of data import and export documentation is available [here.]({{site.baseurl}}/import-export/) to assist with imports from additional sources.
...
For more on importing individual data, check out our helpful article [here.]({{site.baseurl}}/import-export/)
...
Manual boarding is done via the Web Vault. More information on manual user boarding can be found in this [helpful article]({{site.baseurl}}/managing-users/)

### Automated onboarding

Automated user boarding is also available when leveraging Bitwarden Directory Connector - a standalone application available in a [Desktop app]({{site.baseurl}}/directory-sync-desktop/) and a [CLI tool]({{site.baseurl}}/directory-sync-cli/) -  synchronizing user and group information to the Bitwarden Organization. These users are automatically invited to join the Organization, and can be confirmed manually or automatically using the [Bitwarden CLI tool]({{site.baseurl}}/cli/#confirm).
...
- Documentation for multiple Directory Connector options is available [here.]({{site.baseurl}}/directory-connector/)
...
For more information on assigning Collections to Users and Groups, please refer to our help article [here.]({{site.baseurl}}/about-collections/)
...
For more information on filtering and synchronization of Users with the Bitwarden Directory Connector, please check out the article [here.]({{site.baseurl}}/user-group-filters/)
...
More information on permissions can be found on our help site [here.]({{site.baseurl}}/user-types-access-control/#access-control)
...
- A Bitwarden Organization is the encompassing “object” that relates all data for a given sharing entity. Click [here]({{site.baseurl}}/about-organizations/) for more information on Organizations.
...
- Bitwarden and LastPass support User Groups. When migrating to Bitwarden, you can leverage [BWDC]({{site.baseurl}}/directory-connector/) to synchronize your LDAP groups into your Bitwarden Organization.
